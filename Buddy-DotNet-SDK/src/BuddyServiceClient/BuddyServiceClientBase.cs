...
public void Pictures_Filters_ApplyFilter(String BuddyApplicationName, String BuddyApplicationPassword, String UserToken, String ExistingPhotoID, String FilterName, String FilterParameters, String ReplacePhoto, Action<BuddyCallResult<String>> callback){
	IDictionary<string, object> parameters = new Dictionary<string, object>();
	parameters["BuddyApplicationName"] = BuddyApplicationName;
	parameters["BuddyApplicationPassword"] = BuddyApplicationPassword;
	parameters["UserToken"] = UserToken;
	...
	parameters["ReplacePhoto"] = ReplacePhoto;

	
	CallMethodAsync<String>("Pictures_Filters_ApplyFilter", parameters, (bcr) => {
		CallOnUiThread((state) => callback(bcr));
