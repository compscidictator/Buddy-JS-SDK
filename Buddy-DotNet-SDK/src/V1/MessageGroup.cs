...
namespace BuddySDK
{
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of JoinAsync.")]
        ...
        {
            this.Client.Service.GroupMessages_Membership_JoinGroup (this.Client.AppId, this.Client.AppKey, AuthUser.AccessToken,
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of LeaveAsync.")]
        ...
        {
            this.Client.Service.GroupMessages_Membership_DepartGroup (this.Client.AppId, this.Client.AppKey, AuthUser.AccessToken,
                    this.ID.ToString (), (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null && bcr.Error != null) {
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of AddUserAsync.")]
        ...
        {
            this.Client.Service.GroupMessages_Membership_AddNewMember (this.Client.AppId, this.Client.AppKey, AuthUser.AccessToken,
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of RemoveUserAsync.")]
        ...
        {
            this.Client.Service.GroupMessages_Membership_RemoveUser (this.Client.AppId, this.Client.AppKey, AuthUser.AccessToken, userToRemove.ID.ToString (),
                    this.ID.ToString (), (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null && bcr.Error != null) {
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of SendMessageAsync.")]
        ...
        internal void SendMessageInternal (string message, double latitude, double longitude, string appTag, Action<BuddyCallResult<Dictionary<int, bool>>> callback)
        {
            ...
            this.Client.Service.GroupMessages_Message_Send (this.Client.AppId, this.Client.AppKey, AuthUser.AccessToken, this.ID.ToString (), message, latitude.ToString (CultureInfo.InvariantCulture),
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of GetReceivedAsync.")]
        ...
        {
            this.Client.Service.GroupMessages_Message_Get (this.Client.AppId, this.Client.AppKey, AuthUser.AccessToken,
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of DeleteAsync.")]
        ...
        {
            this.Client.Service.GroupMessages_Manage_DeleteGroup (this.Client.AppId, this.Client.AppKey, this.AuthUser.ID.ToString (),
                    this.ID.ToString (), (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null && bcr.Error != null) {
