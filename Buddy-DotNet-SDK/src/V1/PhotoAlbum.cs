...
namespace BuddySDK
{
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of DeleteAsync.")]
        ...
        {
            this.Client.Service.Pictures_PhotoAlbum_Delete (this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken,
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of AddPictureAsync.")]
        ...
        internal void AddPictureInternal (Stream blob, string comment, double latitude, double longitude, string appTag, Action<BuddyCallResult<Picture>> callback)
        {
            ...
            this.Client.Service.Pictures_Photo_Add (this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken, blob, this.AlbumId.ToString (),
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of AddPictureWithWatermarkAsync.")]
        ...
        internal void AddPictureWithWatermarkInternal (Stream photoStream, string comment, double latitude, double longitude, string appTag, string watermarkmessage, Action<BuddyCallResult<Picture>> callback)
        {
            ...
            this.Client.Service.Pictures_Photo_AddWithWatermark (this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken, photoStream, this.AlbumId.ToString (), comment, latitude.ToString (CultureInfo.InvariantCulture), longitude.ToString (CultureInfo.InvariantCulture), appTag, watermarkmessage, (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null) {
                    callback (BuddyResultCreator.Create<Picture> (null, bcr.Error));
        ...
        public  System.Threading.Tasks.Task<BuddySDK.Picture> AddPictureWithWatermark(byte[] blob, string comment = "", double latitude = 0, double longitude = 0, string appTag = "", string watermarkmessage = "") {
         ...
         public System.Threading.Tasks.Task<BuddySDK.Picture> AddPicture(byte[] blob, string comment = "", double latitude = 0, double longitude = 0, string appTag = "") {
