...
namespace BuddySDK
{
    ...
    public class Picture : PicturePublic
    {
        ...
        {
            if (String.IsNullOrEmpty(this.AuthUser.AccessToken))
                throw new Exception("Can't delete photos of other users.");

            this.Client.Service.Pictures_Photo_Delete(this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken,
        ...
        {
            this.Client.Service.Pictures_Filters_GetList(this.Client.AppId, this.Client.AppKey, (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null)
                {
        ...
        internal void ApplyFilterInternal(string filterName, string filterParams, Action<BuddyCallResult<Picture>> callback)
        {
            ...
            this.Client.Service.Pictures_Filters_ApplyFilter(this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken, this.PhotoID.ToString(),
        ...
        {
            this.Client.Service.Pictures_Photo_SetAppTag(this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken, this.PhotoID.ToString(), appTag, (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null && bcr.Error != null)
                {
