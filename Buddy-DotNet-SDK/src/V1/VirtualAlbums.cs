...
namespace BuddySDK
{
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of CreateAsync.")]
        ...
        {
            this.Client.Service.Pictures_VirtualAlbum_Create (this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken,
                        name, appTag, (bcr) =>
            {
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of GetAsync.")]
        ...
        {
            this.Client.Service.Pictures_VirtualAlbum_GetAlbumInformation (this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken, albumId.ToString (), (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null) {
                    callback (BuddyResultCreator.Create<VirtualAlbum> (null, bcr.Error));
        ...
        {
            this.Client.Service.Pictures_VirtualAlbum_Get (this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken, albumId.ToString (), (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null) {
                    callback (BuddyResultCreator.Create<VirtualAlbum> (null, bcr.Error));
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of GetMyAsync.")]
        ...
        {
            this.Client.Service.Pictures_VirtualAlbum_GetMyAlbums (this.Client.AppId, this.Client.AppKey, this.AuthUser.AccessToken, (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != null) {
